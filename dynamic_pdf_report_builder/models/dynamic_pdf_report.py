...
class DynamicPdfReport(models.Model):
    ...
    def _validate_report_configuration(self):
        ...
        if invalid_lines:
            ...
            raise UserError(_("Dynamic reports support only these field types: %s", allowed_types))
    ...
    def _check_field_id(self):
        for line in self:
            ...
            if line.field_type not in ALLOWED_FIELD_TYPES:
                allowed_types = ", ".join(ALLOWED_FIELD_TYPES)
                raise ValidationError(_("Dynamic reports support only these field types: %s", allowed_types))
